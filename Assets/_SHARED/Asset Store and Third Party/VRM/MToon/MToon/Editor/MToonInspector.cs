...
//        private MaterialProperty _outlineCullMode;
        ...
        private MaterialProperty _secondaryTex;
        private MaterialProperty _textureLerp;
...
//            _outlineCullMode = FindProperty(Utils.PropOutlineCullMode, properties);
            ...
            _secondaryTex = FindProperty(Utils.PropSecondaryTex, properties);
            _textureLerp = FindProperty(Utils.PropTextureLerp, properties);
                ...
                EditorGUILayout.BeginVertical(GUI.skin.box);
                {
                    EditorGUILayout.LabelField("Texture", EditorStyles.boldLabel);
                    {
                        materialEditor.TexturePropertySingleLine(new GUIContent("Lit Color, Alpha", "Lit (RGB), Alpha (A)"),
                            _mainTex, _color);
                        materialEditor.TexturePropertySingleLine(new GUIContent("Secondary Tex [Normal]", "Secondary Tex (RGB)"),
                            _secondaryTex, _color);
                        materialEditor.ShaderProperty(_textureLerp, new GUIContent("Texture Lerp", "0 is main, 1 is secondary"));
