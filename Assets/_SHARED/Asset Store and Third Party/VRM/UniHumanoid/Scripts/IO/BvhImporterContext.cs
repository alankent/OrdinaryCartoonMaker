...
namespace UniHumanoid
{
    ...
    public class BvhImporterContext
    {
        ...
        public void Load()
        {
            ...
            //
            Animation = BvhAnimation.CreateAnimationClip(Bvh, scaling, false);
        ...
        public void SaveAsAsset()
        {
            ...
            if (File.Exists(path))
            {
                ...
                //AJK var prefab = AssetDatabase.LoadAssetAtPath<GameObject>(path);
                //AJK PrefabUtility.ReplacePrefab(Root, prefab, ReplacePrefabOptions.ReplaceNameBased);
                bool success;
                PrefabUtility.SaveAsPrefabAsset(Root, path, out success);
                Debug.Log("Save as prefab = " + success);
